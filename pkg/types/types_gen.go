...
func (z *NetworkStats) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 13
	// write "timestamp"
	err = en.Append(0x8d, 0xa9, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70)
	if err != nil {
		return
	}
...
func (z *NetworkStats) Msgsize() (s int) {
	s = 1 + 10 + z.Timestamp.Msgsize() + 12 + z.BlockHeight.Msgsize() + 8 + msgp.Uint64Size + 13 + msgp.Uint64Size + 16 + msgp.Uint64Size + 22 + msgp.Uint64Size + 15 + msgp.Uint64Size + 17 + msgp.Uint64Size + 11 + msgp.Uint64Size + 13 + z.MinerPayouts.Msgsize() + 7 + z.TransactionFees.Msgsize() + 6 + z.Coins.Msgsize() + 12 + z.LockedCoins.Msgsize()
	return
}
	...
	for zb0001 > 0 {
		...
		case "balance":
			...
			for zb0002 > 0 {
				...
				case "locked":
					err = z.Balance.Locked.DecodeMsg(dc)
					if err != nil {
						return
					}
				default:
		...
		case "multisignAddresses":
			...
			if cap(z.MultiSignAddresses) >= int(zb0003) {
				z.MultiSignAddresses = (z.MultiSignAddresses)[:zb0003]
			} else {
				z.MultiSignAddresses = make([]UnlockHash, zb0003)
			}
		...
		case "multisign":
			...
			for zb0004 > 0 {
				...
				case "owners":
					...
					if cap(z.MultiSignData.Owners) >= int(zb0005) {
						z.MultiSignData.Owners = (z.MultiSignData.Owners)[:zb0005]
					} else {
						z.MultiSignData.Owners = make([]UnlockHash, zb0005)
					}
...
func (z *Wallet) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = z.Balance.Locked.EncodeMsg(en)
	if err != nil {
		return
	}
...
func (z *Wallet) Msgsize() (s int) {
	s = 1 + 8 + 1 + 9 + z.Balance.Unlocked.Msgsize() + 7 + z.Balance.Locked.Msgsize() + 19 + msgp.ArrayHeaderSize
	for za0001 := range z.MultiSignAddresses {
...
func (z *WalletBalance) Msgsize() (s int) {
	s = 1 + 9 + z.Unlocked.Msgsize() + 7 + z.Locked.Msgsize()
	return
}
