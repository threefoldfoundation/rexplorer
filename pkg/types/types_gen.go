...
func (z *NetworkStats) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "cbtxc":
			z.CoinBurnTransactionCount, err = dc.ReadUint64()
			if err != nil {
				return
			}
		case "ccdtxc":
		...
		case "tbrtxc":
			z.ThreeBotRegistrationTransactionCount, err = dc.ReadUint64()
			if err != nil {
				return
			}
		case "tbutxc":
			z.ThreeBotUpdateTransactionCount, err = dc.ReadUint64()
			if err != nil {
				return
			}
		case "vtxc":
		...
		case "fft":
			err = z.FoundationFees.DecodeMsg(dc)
			if err != nil {
				return
			}
		case "ct":
...
func (z *NetworkStats) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 20
	// write "cts"
	err = en.Append(0xde, 0x0, 0x14, 0xa3, 0x63, 0x74, 0x73)
	if err != nil {
		return
	}
	...
	// write "cbtxc"
	err = en.Append(0xa5, 0x63, 0x62, 0x74, 0x78, 0x63)
	if err != nil {
		return
	}
	err = en.WriteUint64(z.CoinBurnTransactionCount)
	if err != nil {
		return
	}
	// write "ccdtxc"
	...
	// write "tbrtxc"
	err = en.Append(0xa6, 0x74, 0x62, 0x72, 0x74, 0x78, 0x63)
	if err != nil {
		return
	}
	err = en.WriteUint64(z.ThreeBotRegistrationTransactionCount)
	if err != nil {
		return
	}
	// write "tbutxc"
	err = en.Append(0xa6, 0x74, 0x62, 0x75, 0x74, 0x78, 0x63)
	if err != nil {
		return
	}
	err = en.WriteUint64(z.ThreeBotUpdateTransactionCount)
	if err != nil {
		return
	}
	// write "vtxc"
	...
	// write "fft"
	err = en.Append(0xa3, 0x66, 0x66, 0x74)
	if err != nil {
		return
	}
	err = z.FoundationFees.EncodeMsg(en)
	if err != nil {
		return
	}
	// write "ct"
...
func (z *NetworkStats) Msgsize() (s int) {
	s = 3 + 4 + z.Timestamp.Msgsize() + 4 + z.BlockHeight.Msgsize() + 4 + msgp.Uint64Size + 6 + msgp.Uint64Size + 6 + msgp.Uint64Size + 7 + msgp.Uint64Size + 7 + msgp.Uint64Size + 7 + msgp.Uint64Size + 5 + msgp.Uint64Size + 4 + msgp.Uint64Size + 5 + msgp.Uint64Size + 4 + msgp.Uint64Size + 4 + msgp.Uint64Size + 5 + msgp.Uint64Size + 4 + msgp.Uint64Size + 4 + z.MinerPayouts.Msgsize() + 5 + z.TransactionFees.Msgsize() + 4 + z.FoundationFees.Msgsize() + 3 + z.Coins.Msgsize() + 4 + z.LockedCoins.Msgsize()
	return
}
