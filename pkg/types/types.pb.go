...
func (*PBNetworkStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_b3261ca5678d262b, []int{0}
}
...
func (*PBWallet) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_b3261ca5678d262b, []int{1}
}
...
func (*PBWalletUnlockedBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_b3261ca5678d262b, []int{2}
}
...
func (*PBWalletUnlockedOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_b3261ca5678d262b, []int{3}
}
...
func (*PBWalletLockedBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_b3261ca5678d262b, []int{4}
}
...
func (*PBWalletLockedOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_b3261ca5678d262b, []int{5}
}
...
func (*PBWalletMultiSignData) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_b3261ca5678d262b, []int{6}
}
...
func (*PBThreeBotRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_b3261ca5678d262b, []int{7}
}
...
func init() { proto.RegisterFile("types.proto", fileDescriptor_types_b3261ca5678d262b) }

var fileDescriptor_types_b3261ca5678d262b = []byte{
	...
	,
}
