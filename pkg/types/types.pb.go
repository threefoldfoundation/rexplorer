...
type PBNetworkStats struct {
	...
	FoundationFeeCount                   uint64 `protobuf:"varint,18,opt,name=foundation_fee_count,json=foundationFeeCount" json:"foundation_fee_count"`
	FoundationFees                       []byte `protobuf:"bytes,19,opt,name=foundation_fees,json=foundationFees" json:"foundation_fees"`
	CoinBurnTxCount                      uint64 `protobuf:"varint,20,req,name=coin_burn_tx_count,json=coinBurnTxCount" json:"coin_burn_tx_count"`
}
...
func (*PBNetworkStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_8c1b7a91bc602c90, []int{0}
}
...
func (*PBWallet) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_8c1b7a91bc602c90, []int{1}
}
...
func (*PBWalletUnlockedBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_8c1b7a91bc602c90, []int{2}
}
...
func (*PBWalletUnlockedOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_8c1b7a91bc602c90, []int{3}
}
...
func (*PBWalletLockedBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_8c1b7a91bc602c90, []int{4}
}
...
func (*PBWalletLockedOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_8c1b7a91bc602c90, []int{5}
}
...
func (*PBWalletMultiSignData) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_8c1b7a91bc602c90, []int{6}
}
...
func (*PBThreeBotRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_8c1b7a91bc602c90, []int{7}
}
...
func (m *PBNetworkStats) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1
	i++
	i = encodeVarintTypes(dAtA, i, uint64(m.FoundationFeeCount))
	if m.FoundationFees != nil {
		dAtA[i] = 0x9a
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.FoundationFees)))
		i += copy(dAtA[i:], m.FoundationFees)
	}
	dAtA[i] = 0xa0
	i++
	dAtA[i] = 0x1
	i++
	i = encodeVarintTypes(dAtA, i, uint64(m.CoinBurnTxCount))
	return i, nil
}
...
func (m *PBNetworkStats) Size() (n int) {
	...
	n += 2 + sovTypes(uint64(m.FoundationFeeCount))
	if m.FoundationFees != nil {
		l = len(m.FoundationFees)
		n += 2 + l + sovTypes(uint64(l))
	}
	n += 2 + sovTypes(uint64(m.CoinBurnTxCount))
	return n
}
...
func (m *PBNetworkStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FoundationFeeCount", wireType)
			}
			m.FoundationFeeCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FoundationFeeCount |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FoundationFees", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FoundationFees = append(m.FoundationFees[:0], dAtA[iNdEx:postIndex]...)
			if m.FoundationFees == nil {
				m.FoundationFees = []byte{}
			}
			iNdEx = postIndex
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoinBurnTxCount", wireType)
			}
			m.CoinBurnTxCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CoinBurnTxCount |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	if hasFields[0]&uint64(0x00008000) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("coin_burn_tx_count")
	}
...
func init() { proto.RegisterFile("types.proto", fileDescriptor_types_8c1b7a91bc602c90) }

var fileDescriptor_types_8c1b7a91bc602c90 = []byte{
	...
	,
}
